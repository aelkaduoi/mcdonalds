 ...
 */
class getBezoekerControllerService extends App_KernelDevDebugContainer
{
    /**
     * Gets the public 'App\Controller\BezoekerController' shared autowired service.
     *
     * @return \App\Controller\BezoekerController
     */
    public static function do($container, $lazyLoad = true)
    {
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'vendor'.\DIRECTORY_SEPARATOR.'symfony'.\DIRECTORY_SEPARATOR.'framework-bundle'.\DIRECTORY_SEPARATOR.'Controller'.\DIRECTORY_SEPARATOR.'AbstractController.php';
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Controller'.\DIRECTORY_SEPARATOR.'BezoekerController.php';

        $container->services['App\\Controller\\BezoekerController'] = $instance = new \App\Controller\BezoekerController();
        ...
        ]))->withContext('App\\Controller\\BezoekerController', $container));
